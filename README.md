# 📅 Q/A Assistant Chatbot — RAG-based Application

## 🧠 Project Overview

This application is a **Q/A Assistant Chatbot** built using **Retrieval-Augmented Generation (RAG)**. It allows users to upload their own medical documents (e.g., textbooks, reports), and the system intelligently answers queries by retrieving the most relevant content before generating a final response.
...
```bash
# Clone the repo
$ git clone https://github.com/noramahmudd/Q-A-Assistant-Chatbot.git
$ cd Q/A Assistant/server
